            ...
            <div>
                ...
                <div className='mt-4'>
                    <img src={avatar_url} className='rounded-full h-40' ></img>
                        <p className='font-bold m-2 ml-0 p-2 pl-0'>Mr. Kanav Gopal Dahat</p>
                ...
                <div className='m-2 p-2'>
                    ...
                    <div className='m-2 p-2 '>
                    <div className='m-2 p-2 flex justify-start hover:underline'><img  className="w-5 m-1 mt-0" src={LINKEDIN_IMG_URL}/> <span><a target='_blank' href='https://www.linkedin.com/in/kd28/'>Linkedin</a></span></div>
                    <div className='m-2 p-2 flex justify-start hover:underline'><img  className="w-5 m-1 mt-0" src={INSTAGRAM_IMG_URL}/> <span><a href='https://kanav-portfolio.netlify.app/' target='_blank'>Portfolio website</a></span></div>
                    <div className='m-2 p-2 flex justify-start hover:underline'><img  className="w-5  m-1 mt-0" src={GITHUB_IMG_URL}/> <span><a href='https://github.com/Kanavd55' target='_blank'>Github</a></span></div>
                </div>
                </div>
            </div>
            )
